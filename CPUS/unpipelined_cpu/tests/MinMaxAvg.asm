...
#Array:		.word	34, 78, 43, 67, 91, 56, 25, 69
	...
	#Assert that the array has been stored correctly: 34, 78, 43, 67, 91, 56, 25, 69
	lw    $10 0($11)
	asrti $10 34
	lw    $10 4($11)
	asrti $10 78
...
Main:	add	  $1, $0, $11	# init starting ptr
		...
		asrti $3 25         # Check min
		asrti $4 91         # Check max
		asrti $5 57			# Check average
...
Skip2:	add	  $5, $5, $7	# add element to sum
		...
		#Assert that the correct answer was written to memory
